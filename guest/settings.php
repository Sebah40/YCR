...
$settings['apass'] = 'Chidog#7Happy#6Tailwag#5';

// Website title
$settings['website_title'] = "Yankee Chihuahua Rescue and Adoption";

// Website URL
$settings['website_url'] = 'https://www.yankeechihuahuarescue.org/';

// Guestbook title
$settings['gbook_title'] = "Yankee Chihuahua Rescue Guestbook";

// Your e-mail address.
$settings['admin_email'] = 'info@yankeechihuahuarescue.org';

// URL of the gbook.php file.
$settings['gbook_url'] = 'https://www.yankeechihuahuarescue.org/guest/gbook.php';

// If you want to use a logical anti-SPAM question type it here
$settings['spam_question'] = 'Type access code a1b2c3 here';

// Correct answer to the anti-SPAM logical question
$settings['spam_answer'] = 'a1b2c3';
