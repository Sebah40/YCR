      ...
      <div className="mx-auto max-w-4xl px-6 pb-24">
        <article className="py-10">
          <div className="space-y-6 text-base leading-relaxed text-warm-700">
            <p>
              In Nov of 2007, I had received an e-mail from the Chihuahua meetups group of NH
              ...
              and got my first foster immediately. Then, in early 2008, it was uncertain if YCRAA
              would remain to rescue Chihuahuas, but in late spring 2008 we re-established
              and began rescuing again&hellip; Soon after the restart, I was nominated to the
              Board of Directors and gladly accepted the position.
            </p>
            ...
            <p>
              ...
              first email from the new adopters knowing that each chi has made it through the
              night in its new home and has its own &ldquo;spot&rdquo; is great, and many
            ...
            <p>
              ...
              great compassion for Chihuahuas. There are so many Chis that would have been
