...
const themes: Record<ThemeId, ThemeConfig> = {
  ...
  easter: {
    ...
    decorativeImages: {
      ...
      "events-hero": { src: "/images/scraped/images/holidays/easter/chi-happyeaster.jpg", alt: "Happy Easter chihuahua" },
  ...
  summer: {
    ...
    decorativeImages: {
      ...
      "events-hero": { src: "/images/scraped/images/seasons/summer/summerfest-chi-sign.jpg", alt: "Summerfest chihuahua" },
