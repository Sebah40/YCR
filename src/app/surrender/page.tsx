...
const steps = [
  ...
  "If YCRAA believes the dog is a candidate for surrender, the state coordinator will contact a local evaluator with the dog's information and request an evaluation.",
  ...
  return (
    <div className="bg-cream">
      ...
      <section className="bg-white py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-6">
          <div className="space-y-5 text-base leading-relaxed text-warm-700 sm:text-lg">
            ...
            />
            <p>
              Re-homing your Chihuahua can be a difficult decision and should not be taken
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-6 space-y-5 text-base leading-relaxed text-warm-700">
            ...
            <p>
              ...
              if you can give YCRAA all medical records, registration papers, microchip info
      ...
      <section className="bg-white py-10 sm:py-14">
        <div className="mx-auto max-w-4xl px-6">
          <h2 className="text-3xl font-bold text-warm-900 sm:text-4xl">
            Surrendered dogs must meet the following criteria:
          </h2>
          <div className="mx-auto mt-2 h-1 w-16 rounded-full bg-amber-400" />
